def projectName="kabuki"
folder("tools"){}
pipelineJob("tools/$projectName-build") {
    description("Installs/upgrades $projectName in the cluster.")
    logRotator(-1, 10)
    parameters {
        choiceParam("APP_MODULE", ["shellshock","sleepwalker","silver-surfer","elasticsearch","query","job","merchant"], "Kabuki App module to build")
        stringParam("APP_VER", "1.0.0", "Version Tag for $projectName artifact")
    ...
    definition {
        cpsScm {
            ...
            scriptPath "generated/builds/tools/kabuki/scripts/kabuki_build.groovy"
        }
    }
    configure {
