...
node {
    ...
    stage("Gradle build") {
      sh """
        ${GRADLE5_HOME}/bin/gradle build-info clean build tag-build -Prelease=true -Pbuild.number=$BUILD_NUMBER -Dorg.gradle.java.home=\${JAVA11_HOME}
      """
    }
