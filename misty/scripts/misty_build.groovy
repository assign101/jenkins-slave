...
node {
    ...
    stage("Gradle build") {
      sh """
        ${GRADLE5_HOME}/bin/gradle build-info clean build tag-build -x test -Pbuild.number=$BUILD_NUMBER -Prelease=true -Dorg.gradle.java.home=\${JAVA11_HOME}
      """
    }
