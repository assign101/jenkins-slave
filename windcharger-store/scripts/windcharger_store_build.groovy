def projectName="windcharger-store"
node {
...
bash builderw.sh init
    ...
    stage("Gradle build") {
      sh """
        ${GRADLE5_HOME}/bin/gradle clean build-info build tag-build -Pbuild.number=$BUILD_NUMBER -Prelease=true  -Dorg.gradle.java.home=\${JAVA11_HOME}
      """
    }
