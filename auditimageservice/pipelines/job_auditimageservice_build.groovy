def projectName="auditimageservice"
folder("tools"){}
pipelineJob("tools/$projectName-build") {
    description("Installs/upgrades $projectName in the cluster.")
    logRotator(-1, 10)
    parameters {
        stringParam("DEPLOYMENT_BRANCH", "feature/auditimageservice", "$projectName app branch for build")
    ...
    definition {
        cpsScm {
            ...
            scriptPath "generated/builds/tools/auditimageservice/scripts/auditimageservice_build.groovy"
        }
    }
    configure {
